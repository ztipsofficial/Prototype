$(document).ready(function() {
    ...
    var pK = ca[0];
    // console.log("pk : "+pK);
    var priKey = pK.substring("privateKey=".length,cookieData.length);
    console.log(priKey);
...
function showCheckBox() {
    var checkBox = document.getElementById("boxed-1");
    var text = document.getElementById("showCheckBoxData");
